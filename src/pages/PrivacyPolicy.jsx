  ...
  return (
    <PrivacyPolicyBlock>
      ...
      <p>
        <strong>
          ('http://www.realpianolive.com'이하 'Realpiano Live 리얼피아노 라이브
          신청곡')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
          있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용
          목적이 변경되는 겨우에는 「개인정보 보호법」 제18조에 따라 별도의
      ...
      <ul>
        <li>
          ...
          따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지 목적으로
          개인정보를 처리합니다.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ② 제1항에 따른 권리 행사는Museop Kim에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 Museop Kim은(는) 이에 대해 지체 없이 조치하겠습니다.
        </li>{" "}
        <li>
        ...
        <li>
          ⑥ Museop Kim은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
